...
#define FLAG_RECEIVED_POKEASHES_CASE         0x1DA // FLAG WAS UNUSED IN ORIGINAL CODE

#define FLAG_HAS_MYSTIC_TICKET               0x1DB
#define FLAG_DEFEATED_HO_OH                  0x1DC
#define FLAG_DEFEATED_LUGIA                  0x1DD

#define FLAG_STILL_DEVELOPING_0              0x1DE // FLAG WAS UNUSED IN ORIGINAL CODE
...
#define FLAG_SYS_NOPOKE_MODE                        (SYSTEM_FLAGS + 0x85) // Unused Flag
